...
# Tick-Koordination erfolgt durch LevelController (Zwei-Phasen: phase_1_plan / phase_2_commit).
# Bei Wand/Blocker/anderem Lemming: dreht um 180°.
...
## Wird in phase_1_plan() gesetzt; von LevelController für Konfliktauflösung gelesen.
...
func initialize(
	...
	# Lemming im Positions-Dictionary registrieren
...
## Phase 1: Berechnet das Ziel-Tile ohne grid_pos zu ändern.
## snapshot ist ein Snapshot von lemming_positions zu Tick-Beginn.
...
## Phase 2: Committet die geplante Bewegung und aktualisiert grid_pos.
## will_move kann zwischen Phase 1 und Phase 2 vom LevelController auf false gesetzt worden sein
## (Konfliktauflösung bei mehreren Lemmingen die dasselbe Tile wollen).
